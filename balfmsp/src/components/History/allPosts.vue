  ...
  <div>
    ...
    >
      <div class="bg-primary d-flex flex-centre p-3 pl-5 w-50 mb-5 text-light">
        <h2 class="ml-5">Historic Posts</h2>
      </div>
      <div class="row m-0 d-flex flex-center">
        <div
          class="news-col bg-white p-4 my-4 p-4 mx-md-2 col-12col-12 col-md-6 col-lg-4"
          v-for="(post, index) in paginatedData"
          :key="index"
        >
          <img class="img-fluid" :src="post.image" :alt="post.alt" />
